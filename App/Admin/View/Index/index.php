		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
				<li class="dropdown dropdown-user">
					...
					<span class="username username-hide-on-mobile">{{$_SESSION['info']['username']}}</span>
					<i class="fa fa-angle-down"></i>
					</a>
					<ul class="dropdown-menu dropdown-menu-default">
						<li>
							<a href="{{U('Index/changePassword')}}">
		...
		<div class="page-sidebar navbar-collapse collapse">
			<ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					...
					<ul class="sub-menu">
						<li>
							<a href="{{U('Shoptype/add')}}">
							添加类型</a>
						</li>
						<li>
							<a href="{{U('Shoptype/index')}}">
							类型列表</a>
						</li>
						<li>
							<a href="{{U('Shopcate/add')}}">
							添加分类</a>
						</li>
						<li>
							<a href="{{U('Shopcate/index')}}">
							分类列表</a>
						</li>
						<li>
							<a href="{{U('Brand/add')}}">
						...
						<li>
							<a href="{{U('Shoplist/add')}}">
							添加商品</a>
						</li>
						<li>
							<a href="{{U('Shoplist/index')}}">
							商品列表</a>
						</li>
					</ul>
				</li>
				<li>
					...
					<ul class="sub-menu">
						<li>
							<a href="{{U('Arccate/add')}}">
								添加分类
							</a>
						</li>
						<li>
							<a href="{{U('Arccate/index')}}">
								文章分类
							</a>
						</li>
						<li>
				...
				<li>
					...
					<ul class="sub-menu">
						<li>
							<a href="{{U('User/user')}}">用户中心</a>
						</li>
						<li>
							<a href="{{U('User/Role')}}">添加角色</a>
						</li>
						<li>
							<a href="{{U('User/Power')}}">添加权限</a>
						</li>
					</ul>
				</li>
			</ul>
