...
//			检测用户是否存在地址
			var userurl = "{{U('Register/user')}}";
//			验证码
			var codeurl = "{{U('Register/codes')}}";
		</script>
	...
	<body>
		...
		<div id="container">
				...
				<form action="register.html" method="post" id="from">
					...
					<div class="bord">
						<div class="form_item">
							...
							<img src="{{U('Register/code')}}" onclick="this.src='{{U('Register/code')}}&i='+Math.random()" style="margin-top: 4px;" />
							<!--验证码-->
						</div>
						<div class="input_tip">
							<i></i>
			...
			<div class="right">
				<div class="phone"></div>
				<div class="enter">
					<!--<a href="{{U('Register/qe_index')}}"><b></b>企业用户注册</a>-->
				</div>
			</div>
		</div>
		<!--底部-->
