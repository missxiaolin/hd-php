			...
			<div class="jz">
				<div class="sy">
					...
					<div class="notive">
						<div class="now">
							...
							<ul>
								<?php foreach ($arcData as $v){?>
									<li>
										<a href="arclist_<?php echo $v['wid']?>.html">
											<span>[<?php echo $v['cate']?>]</span><?php echo $v['title']?>
										</a>
									</li>
								<?php }?>
							</ul>
						...
						<div class="tg">
							<a href="<?php echo U('Shop/shop',array('gid'=>12))?>"><img src="./Public/index/images/210.jpg"/></a>
						</div>
					</div>
				</div>
			...
			<div class="mc">
				<div class="mc_left">
					<div class="side">
						...
						<ul class="insider">
							<li class="fore1">
								<a href="<?php echo U('Shop/shoplist',array('cid'=>28))?>">
									<i class="polo"></i>
									<span>男装</span>
								</a>
							</li>
							<li class="fore2">
								<a href="<?php echo U('Shop/shoplist',array('cid'=>29))?>">
									<i></i>
									<span>女装</span>
								</a>
							</li>
							<li class="fore3">
								<a href="<?php echo U('Shop/shoplist',array('cid'=>31))?>">
									<i></i>
									<span>内衣</span>
								</a>
							</li>
							<li class="fore4">
								<a href="<?php echo U('Shop/shoplist',array('cid'=>35))?>">
									<i></i>
									<span>鞋靴</span>
								</a>
							</li>
							<li class="fore5">
								<a href="<?php echo U('Shop/shoplist',array('cid'=>36))?>">
									<i class="polo"></i>
									<span>箱包</span>
								</a>
							</li>
							<li class="fore6">
								<a href="<?php echo U('Shop/shoplist',array('cid'=>38))?>">
									<i class="polo"></i>
									<span>奢侈品</span>
								</a>
							</li>
						...
						<ul class="two">
							<li>
								<a href="<?php echo U('Shop/shoplist',array('cid'=>29))?>" class="jia">女装新品</a>
								<a href="<?php echo U('Shop/shoplist',array('cid'=>35))?>">品质男鞋</a>
								<a href="<?php echo U('Shop/shoplist',array('cid'=>9))?>">服装城</a>
								<a href="<?php echo U('Shop/shoplist',array('cid'=>65))?>">太阳镜</a>
								<a href="<?php echo U('Shop/shoplist',array('cid'=>66))?>">时尚女鞋</a>
								<a href="<?php echo U('Shop/shoplist',array('cid'=>38))?>">奢侈品</a>
								<a href="<?php echo U('Shop/shoplist',array('cid'=>67))?>">仿皮皮衣</a>
							</li>
							<li>
								<a href="<?php echo U('Shop/shoplist',array('cid'=>36))?>">箱包</a>
								<a href="<?php echo U('Shop/shoplist',array('cid'=>37))?>" class="jia">珠宝</a>
								<a href="<?php echo U('Shop/shoplist',array('cid'=>30))?>">童装</a>
								<a href="<?php echo U('Shop/shoplist',array('cid'=>62))?>">衬衫</a>
								<a href="<?php echo U('Shop/shoplist',array('cid'=>63))?>">卫衣</a>
								<a href="<?php echo U('Shop/shoplist',array('cid'=>64))?>" class="jia">T桖</a>
								<a href="<?php echo U('Shop/shoplist',array('cid'=>68))?>">钱包</a>
								<a href="<?php echo U('Shop/shoplist',array('cid'=>69))?>">服饰</a>
							</li>
						</ul>
					</div>
				</div>
               ...
               <?php }?>>
					<ul class="p_list">
						...
						<?php foreach ($v['shop'] as $shop){?>
							<li>
								<div class="p_img">
									<a href="<?php echo U('Shop/shop',array('gid'=>$shop['gid']))?>"><img src="<?php echo $shop['pic']?>"/></a>
								</div>
								<a href="<?php echo U('Shop/shop',array('gid'=>$shop['gid']))?>" class="p_name"><?php echo $shop['gname']?></a>
								<span class="p_price"><span>￥</span><?php echo $shop['shopprice']?>.<span>00</span></span>
							</li>
						<?php }?>
			...
			<div class="mc add">
				<div class="mc_left two_layer">
					<div class="side">
						...
						<ul class="insider">
							<li class="fore1">
								<a href="<?php echo U('Shop/shoplist',array('cid'=>274))?>">
									<i class="polo"></i>
									<span>美妆特卖</span>
								</a>
							</li>
							<li class="fore2">
								<a href="<?php echo U('Shop/shoplist',array('cid'=>278))?>">
									<i></i>
									<span>个护清洁</span>
								</a>
							</li>
							<li class="fore3">
								<a href="<?php echo U('Shop/shoplist',array('cid'=>265))?>">
									<i></i>
									<span>女士香水</span>
								</a>
							</li>
							<li class="fore4">
								<a href="<?php echo U('Shop/shoplist',array('cid'=>281))?>">
									<i></i>
									<span>除虫用品</span>
								</a>
							</li>
						...
						<ul class="two">
							<li><a href="<?php echo U('Shop/shoplist',array('cid'=>266))?>">男士香水></a></li>
							<li><a href="<?php echo U('Shop/shoplist',array('cid'=>274))?>">美妆工具></a></li>
						</ul>
						<ul class="two_2">
							<li>
								<a href="<?php echo U('Shop/shoplist',array('cid'=>288))?>" class="zj">家居日用</a>
								<a href="<?php echo U('Shop/shoplist',array('cid'=>277))?>">衣物清洁</a>
								<a href="<?php echo U('Shop/shoplist',array('cid'=>282))?>">皮具护理</a>
								<a href="<?php echo U('Shop/shoplist',array('cid'=>276))?>" class="zj">纸品</a>
								<a href="<?php echo U('Shop/shoplist',array('cid'=>280))?>">一次性用品</a>
							</li>
						</ul>
					</div>
				</div>
