...
//				删除指定不要的商品
		...
		<?php if(!isset($shopData)){?>
			...
			<div id="crumbs_nav">
				<div id="crumbs_nav">
					<div class="inner">
						<div class="taogongzai">
							<img src="./Public/index/images/shop/kj.jpg" alt="" style="width:120px;">
						</div>
		...
		<!--商品筛选-->
		<div id="J_selector" style="margin-top:40px;">
			<!--第一个品牌-->
			<?php if(isset($brand)){?>
								...
								<?php foreach ($brand as $k=>$v){?>
									<?php foreach ($v as $value){?>
										<li data_initial="<?php echo $k?>">
											<a href="<?php echo U('shoplist',array('cid'=>$_GET['cid'],'param'=>Q('get.param'),'bid'=>$value['bid']))?>" <?php if($bid==$value['bid']){?>
						...
						<div class="pp">
							<ul>
								...
								<?php foreach ($v['value'] as $value){?>
									...
									?>
									<li>
										<a href="<?php echo U('shoplist',['cid'=>$_GET['cid'],'param'=>implode('_',$temp),'bid'=>isset($_GET['bid'])?$_GET['bid']:0])?>" <?php if($value['gtid']==$param[$k]){?>
                style="color:red;font-weight:700;"
