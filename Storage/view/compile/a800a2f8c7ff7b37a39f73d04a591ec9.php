			...
			<div class="top_middle">
				<div class="top_right">
					<ul>
						...
						<li>
							<p class="gy">
								<a href="javascript:;" class="gb">关于京东<i class="iconfont">&#xe652;</i></a>
							</p>
							<div class="box gyjd">
               ...
               "/>
						...
						<div class="xinxi">
							...
							<div class="tb" style="margin-top:5px;">
								<a href="javascript:;" class="tb_my"><i></i></a>
								...
								<?php foreach ($brand as $k=>$v){?>
									<?php foreach ($v as $value){?>
										<li data_initial="<?php echo $k?>">
												<a href="<?php echo U('shoplist',array('cid'=>$_GET['cid'],'seach'=>$_GET['seach'],'param'=>Q('get.param'),'bid'=>$value['bid']))?>" <?php if($bid==$value['bid']){?>
						...
						<div class="pp">
							<ul>
								...
								<?php foreach ($v['value'] as $value){?>
									...
									?>
									<li>
										<a href="<?php echo U('shoplist',['cid'=>$_GET['cid'],'seach'=>$_GET['seach'],'param'=>implode('_',$temp),'bid'=>isset($_GET['bid'])?$_GET['bid']:0])?>" <?php if($value['gtid']==$param[$k]){?>
                style="color:red;font-weight:700;"
