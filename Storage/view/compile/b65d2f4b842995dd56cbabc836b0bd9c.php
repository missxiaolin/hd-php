...
//			性别
			var sex = "<?php echo $oldData['sex']?>";
//			年月日
			var year = "<?php echo $oldData['birthday'][0]?>";
			var month = "<?php echo $oldData['birthday'][1]?>";
			var day = "<?php echo $oldData['birthday'][2]?>";
//			婚姻
			var wedlock ="<?php echo $oldData['wedlock']?>";
//			月收入
			var revenue ="<?php echo $oldData['revenue']?>";
//			教育程度
			var education = "<?php echo $oldData['education']?>";
		</script>
	...
	<body>
		...
		<!--<dl>
			...
			<div class="downer">
				<div class="man_top">
					<ul>
						<li><a href="my.html" <?php if('index'=='index'){?>
                class="cure"
               <?php }?>>基本信息</a></li>
						<li><a href="portrait.html" <?php if('index'=='portrait'){?>
                class="cure"
               <?php }?>>头像照片</a></li>
					</ul>
				</div>
				<div class="man_info">
						...
						<div class="from">
							<form action="my.html" method="post" id="userfrom">
								...
								<div class="item">
									...
									<div class="fl">
										<input type="tel" name="username" class="username" id="" value="<?php echo $oldData['username']?>" />
									</div>
								</div>
								<div class="item">
									<span class="label">
								...
								<div class="item">
									...
									<div class="fl">
										<input type="text" class="user" name="name" id="" value="<?php echo $oldData['name']?>" />
									</div>
								</div>
								<div class="item">
									<span class="label">
									...
									<div class="fl">
										<input type="text" class="user" name="cellphone" id="" value="<?php echo $oldData['cellphone']?>" />
									</div>
								</div>
								<div class="item">
									<span class="label">
									...
									<div class="fl">
										<input type="text" class="user" name="telphone" id="" value="<?php echo $oldData['telphone']?>" />
									</div>
								</div>
								...
								<div class="item">
									...
									<div class="fl">
										<input type="text" class="user" name="idcard" id="" value="<?php echo $oldData['idcard']?>" />
									</div>
								</div>
								<div class="item">
									<span class="label">
					...
					<div class="user_info">
						<div class="u_pic">
							<?php if(!empty($oldData['user_thum'])){?>
                
								<img src="<?php echo $oldData['user_thum']?>"/>
							<?php }else{?>
               ...
               <?php }?>
						...
						<div class="info_m">
							<div class="top_info">
								<b>用户名：<?php echo $oldData['account']?></b>
							</div>
							<!--<div class="hy">
								<i></i>
